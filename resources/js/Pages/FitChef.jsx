...
export default function FitChef({ auth }) {
    ...
    const handleGenerate = async () => {
        ...
        if (!API_KEY) {
            alert("API Key not found in .env (VITE_GEMINI_API_KEY)!");
            setLoading(false);
            return;
        }
        ...
        try {
            ...
            const prompt = `
                You are a professional nutritionist and chef. Suggest 3 distinct, healthy recipes using these ingredients (and basic pantry staples): ${ingredients.join(', ')}. 
                Return the result ONLY as a raw JSON array (no markdown code blocks, just the array) where each object has these exact keys:
                - title (string)
            ...
            const recipesData = JSON.parse(cleanText);
            ...
            alert("Failed to generate recipes. Please check the API Key or try again.");
            setLoading(false);
        }
    };
                ...
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-12">
                    ...
                    <div className="text-center space-y-4">
                        <h1 className="text-5xl font-extrabold text-gray-900 dark:text-white tracking-tight">
                            FitChef AI Recipe Generator
                        </h1>
                        <p className="text-xl text-gray-500 dark:text-gray-400 max-w-2xl mx-auto">
                            Enter the ingredients you have, and let our AI create healthy, delicious recipes for your family.
                        </p>
                    </div>
                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-3xl p-8 shadow-xl max-w-4xl mx-auto border border-gray-100 dark:border-gray-700">
                        ...
                        <div className="relative mb-6">
                            ...
                            <input
                                ...
                                placeholder="Type ingredients (e.g., chicken, rice, broccoli)... press Enter to add"
                                value={inputValue}
                        ...
                        <button
                            ...
                            className={`w-full sm:w-auto px-8 py-4 bg-emerald-500 hover:bg-emerald-600 text-white font-bold rounded-xl shadow-lg shadow-emerald-500/30 transition-all transform hover:scale-[1.02] flex items-center justify-center gap-2 ${loading ? 'opacity-70 cursor-not-allowed' : ''}`}
                        >
                            {loading ? (
                                <>
                    ...
                    {recipes && (
                        <div className="space-y-8 animate-fade-in-up">
                            <h3 className="text-3xl font-bold text-gray-900 dark:text-white text-center">Here's What We Cooked Up For You...</h3>

                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                                {recipes.map((recipe, idx) => (
                                    <div key={idx} className="bg-white dark:bg-gray-800 rounded-3xl p-6 shadow-lg border border-gray-100 dark:border-gray-700 flex flex-col h-full hover:border-emerald-500 transition-colors group">
                                        <div className="mb-4">
